...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', type=str, choices=['ddr-ce','connah-ddr', 'ddr-focal','ddr-cp-aware','dfuc-ce','dfuc-cp-aware','dfuc-focal','ddr-cp-aware','isic-ce','isic-focal','isic-cp-aware'],
    ...
    parser.add_argument('-score_functions', type=str,  nargs='+', 
                        ...
                        '"softmax", "APS", "RAPS", "SAPS", "TACP_APS", "sTACP_APS", '
                        '"TACP_RAPS", "sTACP_RAPS", "FRAPS"')
